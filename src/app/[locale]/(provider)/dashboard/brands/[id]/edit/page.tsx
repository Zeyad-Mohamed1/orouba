...
export default function EditBrandPage() {
    ...
    useEffect(() => {
        const fetchBrand = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/brands/${id}`);
                if (response.status === 200) {
                    ...
                    setFormData({
                        ...
                        brand_text_ar: brand.brand_text_ar,
                        brand_text_en: brand.brand_text_en,
                        color: brand.color,
                        main_image: brand.main_image,
                        banner: brand.banner,
                        small_img: brand.small_img,
                        main_image_preview: brand.main_image,
                        banner_preview: brand.banner,
                        small_img_preview: brand.small_img,
                    });
                }
            } catch (error) {
    ...
    // Update rich text editor onChange handlers
    ...
    // Update file input onChange handlers
    ...
    const validateStep = (step: number): boolean => {
        ...
        switch (step) {
            case STEPS.BASIC_INFO:
                ...
                if (!formData.description_ar) errors.description_ar = t("errors.required");
                if (!formData.description_en) errors.description_en = t("errors.required");
                break;

            case STEPS.CONTENT:
                if (!formData.brand_text_ar) errors.brand_text_ar = t("errors.required");
                if (!formData.brand_text_en) errors.brand_text_en = t("errors.required");
                break;
                    ...
                    >
                        <FormRow>
                            <FormGroup>
                                ...
                                {validationErrors.name_ar && (
                                    <FormHelperText error>{validationErrors.name_ar}</FormHelperText>
                                )}
                            </FormGroup>
                            ...
                            <FormGroup>
                                ...
                                {validationErrors.name_en && (
                                    <FormHelperText error>{validationErrors.name_en}</FormHelperText>
                                )}
                            </FormGroup>
                        </FormRow>
                        ...
                        <FormGroup span="full">
                            ...
                            <Editor
                                ...
                                onChange={(value) => handleRichTextChange("description_ar", value)}
                        ...
                        <FormGroup span="full">
                            ...
                            <Editor
                                ...
                                onChange={(value) => handleRichTextChange("description_en", value)}
                    ...
                    >
                        <FormGroup span="full">
                            ...
                            <Editor
                                ...
                                onChange={(value) => handleRichTextChange("brand_text_ar", value)}
                        ...
                        <FormGroup span="full">
                            ...
                            <Editor
                                ...
                                onChange={(value) => handleRichTextChange("brand_text_en", value)}
